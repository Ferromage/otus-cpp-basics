...
static constexpr size_t dustCountMax = 200;
...
World::World(const std::string& worldFilePath) {
    ...
    while (stream.peek(), stream.good()) {
        ...
        balls.push_back(Ball(center, Velocity(velocityVector), color, radius, isCollidable));
    }
    
    dust.resize(dustCountMax);
}
